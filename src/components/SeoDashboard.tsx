...
import { TrendingUp, MousePointerClick, Target, Users, Activity, DollarSign, Link2 } from 'lucide-react';
...
const METRICS: Metric[] = [
  { label: 'Backlinks Built', value: 48, suffix: 'K', icon: Link2, color: 'text-accent-400' },
  { label: 'Keywords Ranked', value: 1240, suffix: '+', icon: Target, color: 'text-violet-400' },
  { label: 'Avg DA Increase', value: 24, suffix: '+', icon: TrendingUp, color: 'text-success-500' },
  { label: 'Referring Domains', value: 320, suffix: '+', icon: Users, color: 'text-accent-400' },
  { label: 'Organic Traffic', value: 4, suffix: 'x', icon: DollarSign, color: 'text-success-500' },
  { label: 'Cost-per-Link', value: 45, suffix: '', icon: Activity, color: 'text-violet-400' },
];
  ...
  return (
    <div ref={ref} className="glass-card p-5">
      <div className="mb-4 flex items-center justify-between">
        <div>
          <div className="text-sm font-semibold text-white">Link Building Performance</div>
          <div className="text-xs text-navy-300">Rankings growth over 12 months</div>
        </div>
      ...
      <div className="glass-card-light overflow-hidden p-5 sm:p-6">
        <div className="mb-5 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-sm font-bold text-navy-800">Link Building Dashboard</div>
              <div className="text-xs text-navy-400">Live project overview</div>
            </div>
          </div>
