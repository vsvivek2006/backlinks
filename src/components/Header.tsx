        ...
        <div className="container-x px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between lg:h-20">
            ...
            <nav className="hidden lg:flex items-center gap-1 xl:gap-1.5">
              {NAV_LINKS.map((link) => (
                ...
                >
                  <Link
                    to={link.to}
                    className="flex items-center gap-1 rounded-lg px-3 py-2 text-sm font-medium text-navy-100 transition-colors hover:text-white whitespace-nowrap"
                  >
                    {link.label}
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <a
                href={`tel:${SITE.phone}`}
                className="hidden xl:flex items-center gap-2 rounded-xl bg-white/10 px-3 py-2 text-sm font-semibold text-white backdrop-blur-md border border-white/10 transition-colors hover:bg-white/15"
              >
              ...
              <Link
                to="/contact"
                className="hidden sm:inline-flex rounded-xl bg-accent-500 px-4 py-2.5 text-sm font-semibold text-white shadow-lg shadow-accent-500/25 transition-all hover:bg-accent-600 hover:-translate-y-0.5 lg:px-6 whitespace-nowrap"
              >
                Free Link Audit
              </Link>
