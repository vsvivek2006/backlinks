...
import { Link2, Phone, MessageCircle, MapPin, Mail, ArrowRight } from 'lucide-react';
import { SITE, SERVICES, LOCATIONS } from '@/data/site';

const FOOTER_SERVICES = [
  { label: 'High DA Backlinks', to: '/services/high-da-backlinks' },
  { label: 'Guest Posts', to: '/services/guest-post-backlinks' },
  { label: 'Niche Edits', to: '/services/niche-edit-backlinks' },
  { label: 'Web 2.0', to: '/services/web-2-0-backlinks' },
  { label: 'Competitor Analysis', to: '/services/competitor-backlink-analysis' },
  { label: 'Link Audit', to: '/services/link-building-audit' },
];
          ...
          <div>
            <Link to="/" className="flex items-center gap-2.5">
              ...
              <div className="flex flex-col leading-none">
                <span className="text-base font-bold text-white font-display">Growth Service</span>
                <span className="text-[10px] font-medium text-accent-300 uppercase tracking-wider">Backlinks</span>
              </div>
            </Link>
            <p className="mt-4 text-sm leading-relaxed text-navy-300">
              Growth Service Backlinks builds high-authority, white-hat backlinks that improve search rankings and drive organic traffic for businesses across Jaipur and India.
            </p>
          ...
          <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
            <div>
              ...
              <p className="mt-1 text-xs text-navy-400">
                Growth Service Backlinks operates as a specialized backlink building brand under {SITE.parentCompany}.
              </p>
            </div>
            <a
        ...
        <div className="mt-10 border-t border-white/10 pt-6">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            <p className="text-sm text-navy-400">
              &copy; 2026 Growth Service Backlinks. All Rights Reserved.
            </p>
