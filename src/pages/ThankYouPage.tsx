...
export default function ThankYouPage() {
  return (
    <>
      <Seo
        title="Thank You | Growth Service Backlinks"
        description="Thank you for contacting Growth Service Backlinks. Our team will get back to you within one business day."
        canonical="/thank-you"
        noindex
      />
        ...
        <Container>
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-5 text-lg text-navy-600 animate-fade-in-up">
              Your message has been received. Our Backlink Building team will review your request and get back to you within one business day with your free link audit.
            </p>
            ...
            <div className="mt-12 rounded-2xl border border-navy-100 bg-navy-50 p-6 text-left">
              ...
              <div className="mt-4 space-y-3">
                {[
                  'Our team reviews your website and Backlink Building requirements',
                  'We prepare a preliminary link audit covering project, content for link building, and content factors',
                  'We contact you within one business day with findings and recommendations',
                  'If you decide to work with us, we create a custom link building strategy for your business',
                ].map((step, i) => (
            ...
            <div className="mt-8">
              <Link to="/blog" className="text-sm font-semibold text-accent-600 hover:underline">
                Rewebsite our Backlink Building blog while you wait
              </Link>
            </div>
          </div>
        </Container>
