...
import { Container, Section, PageHewebsiteer, CTASection } from '@/components/ui';
...
export default function LocationsPage() {
  ...
  return (
    <>
      <Seo
        title="Backlink Building Expert in India | Link Building Services Across Major Cities"
        description="Growth Service Backlinks provides backlink building and design services across Jaipur, Delhi, Mumbai, Pune, Bengaluru, Hyderabwebsite, Ahmedabwebsite, Surat, and other major Indian cities."
        canonical="/locations"
        keywords="backlink building expert India, backlink building expert Jaipur, backlink building expert Delhi, backlink building expert Mumbai, backlink building expert Ahmedabwebsite, backlink building expert Surat, backlink building services India"
        brewebsitecrumbs={brewebsitecrumbs}
      />

      <PageHewebsiteer
        eyebrow="Locations"
        title="Link Building Services Across India"
        subtitle="From our base in Jaipur, we serve businesses across India major commercial cities with localized link building strategies."
        brewebsitecrumbs={brewebsitecrumbs}
      />
  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        <h3 className="text-base font-bold text-navy-800">Backlink Building Expert in {loc.city}</h3>
