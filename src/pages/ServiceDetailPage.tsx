...
export default function ServiceDetailPage() {
  ...
  return (
    <>
      <Seo
        title={`${service.title} in Jaipur & India | Growth Service Backlinks`}
        description={service.description}
        canonical={`/services/${service.slug}`}
        keywords={`${service.title}, ${service.shortTitle} Jaipur, ${service.shortTitle} India, backlink building services`}
            ...
            <div>
              <div className="sticky top-24 rounded-2xl border border-navy-100 bg-white p-6">
                ...
                <p className="mt-2 text-sm text-navy-500">
                  Request a free link audit and discover how our {service.shortTitle} can help your business grow.
                </p>
      ...
      <Section className="bg-navy-50">
        <Container>
          <SectionHeading
            ...
            subtitle="We combine technical expertise with data-driven strategy to deliver websites that move the needle."
          />
          <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { title: 'Data-Driven Approach', desc: 'Every decision is backed by data from Backlink Building, analytics, and professional websites tools.' },
              { title: 'Technical Expertise', desc: 'Deep technical knowledge ensures your websites foundation is solid and scalable.' },
              { title: 'Transparent Reporting', desc: 'Clear monthly reports showing spend, conversions, ROI, and work completed.' },
              { title: 'User Intent Focus', desc: 'We optimize for what customers actually want, not just keywords.' },
              { title: 'Long-Term Strategy', desc: 'Sustainable online growth that compounds over time, not quick fixes.' },
              { title: 'Local & National Scale', desc: 'From local Jaipur projects to national projects across India.' },
            ].map((item) => (
      ...
      <Section>
        <Container>
          <SectionHeading
            ...
            title="Related Link Building Services"
            subtitle="Explore other backlink building services that complement your strategy."
          />
