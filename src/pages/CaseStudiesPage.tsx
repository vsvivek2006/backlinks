...
export default function CaseStudiesPage() {
  ...
  return (
    <>
      <Seo
        title="Backlink Building Case Studies | Real Results | Growth Service Backlinks"
        description="See how our data-driven link building strategies have helped businesses grow organic traffic, keyword visibility, and qualified leads. Real Backlink Building case studies with transparent results."
        canonical="/case-studies"
        keywords="Backlink Building case studies, Backlink Building results, organic traffic growth, keyword visibility, Backlink Building ROI"
      ...
      <PageHewebsiteer
        ...
        subtitle="See how our data-driven link building strategies have helped businesses grow organic traffic, keyword visibility, and qualified leads. We only publish real data — never fabricated results."
        brewebsitecrumbs={brewebsitecrumbs}
      />
              ...
              >
                ...
                <div className="rounded-2xl bg-navy-800 p-8 text-white">
                  ...
                  <div className="mt-8 flex items-center gap-2 rounded-xl bg-white/5 p-4 text-sm text-navy-200">
                    ...
                    Results achieved over 6-12 months of sustained Backlink Building effort.
                  </div>
                </div>
              </div>
            ))}
      ...
      <CTASection
        ...
        subtitle="Get a free link audit and discover how we can help you achieve similar growth in organic traffic and leads."
      />
    </>
  );
}
