...
export default function SitemapPage() {
  ...
  return (
    <>
      <Seo
        title="Sitemap | Growth Service Backlinks"
        description="Complete sitemap of Growth Service Backlinks website. Find all our pages including services, locations, industries, blog posts, and more."
        canonical="/sitemap"
          ...
          <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2.5">
                ...
                <li><Link to="/services" className={linkClass}>Link Building Services</Link></li>
            ...
            {/* Services */}
            <div>
              <h2 className="text-lg font-bold text-navy-800">Link Building Services</h2>
              <ul className="mt-4 space-y-2.5">
                {SERVICES.map((s) => (
                  <li key={s.slug}>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2.5">
                {LOCATIONS.map((l) => (
                  <li key={l.slug}>
                    <Link to={`/locations/${l.slug}`} className={linkClass}>Backlink Building Expert in {l.city}</Link>
                  </li>
                ))}
              </ul>
            </div>
